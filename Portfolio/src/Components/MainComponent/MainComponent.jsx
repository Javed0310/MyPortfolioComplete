      ...
      <div className={`bg-dark text-light ${style.mainComp}`}>
        ...
        >
          ...
          <p className="text-white fs-6 text-align-justify mb-4">
            ...
            expertise in a range of programming languages and a dedication to
            staying abreast of the latest web development trends, I'm committed
            to bringing clients' visions to life and exceeding their
            expectations in the digital realm. Whether it's building responsive
            layouts, optimizing user interfaces, or implementing cutting-edge
            technologies, I thrive on turning ideas into reality in the
            ever-evolving landscape of the web.
          </p>
